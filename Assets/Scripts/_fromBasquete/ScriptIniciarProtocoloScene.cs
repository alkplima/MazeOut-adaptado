...
public class ScriptIniciarProtocoloScene : MonoBehaviour
{
    public GameObject sphHomem1, sphHomem2, sphHomem3, menino, bola, miniTelas, maxiTelas, placarPenalizacao;
    [HideInInspector]
    ...
    void Start()
    {
        VariaveisGlobais.emProcessoDeProtocolo = true;
    ...
    void OldStart()
    {
        ...
        VariaveisGlobais.DuracaoJogo = 585; // 45 + 180 + 180 + 180
        VariaveisGlobais.TipoMarcacao = "Zona";
        VariaveisGlobais.QuantidadeDefensores = 3;
        VariaveisGlobais.TipoInterface = "Webcam1";
        VariaveisGlobais.VelocidadeDefensores = 1;

        VariaveisGlobais.tempoParaVoltarALancarAposErrar = 0;
        ...
        if (contagem_regressiva)
        {
            ...
            if (counter321 == 0)
            {
                ...
                if (placarPenalizacao)
                    placarPenalizacao.SetActive(true);
            }
